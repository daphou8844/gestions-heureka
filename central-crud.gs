...
const NEW_SHEETS = {
  ...
  EMPLOYES:    'Employés',
  CHANTIERS:        'Chantiers',
  TACHES_CHANTIER:  'TachesChantier',
  PLANNING:         'Planning',
  PUNCH:       'Punch',
...
const NEW_HEADERS = {
  ...
  CHANTIERS:        ['ID_Chantier', 'Projet_ID',   'Client_ID',  'Nom',      'Adresse',   'Statut',     'Date_Début', 'Date_Fin_Prévue', 'Budget', 'Notes', 'Archivé', 'Progression', 'Date_Créé'],
  TACHES_CHANTIER:  ['ID_Tache',   'Chantier_ID', 'Projet_ID',  'Phase',    'Texte',     'Complétée',  'Personnalisée', 'Date_Créé', 'Date_Complétée'],
...
const NEW_COLORS = {
  ...
  TACHES_CHANTIER:  { bg: '#1a1000', fg: '#D4AF37' },
